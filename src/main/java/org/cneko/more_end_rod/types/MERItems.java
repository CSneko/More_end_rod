...
import org.cneko.more_end_rod.items.energy.IndustrialRod;
...
public class MERItems {
    ...
    public static final IndustrialRod INDUSTRIAL_ROD = new IndustrialRod(); // 工业末地烛
    ...
    public static void register(){
        ...
        Registry.register(Registries.ITEM,new Identifier(modId,"industrial_rod"),INDUSTRIAL_ROD); //工业末地烛
    }
}
